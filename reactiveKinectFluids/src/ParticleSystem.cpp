...
void ParticleSystem::updateAndDraw(const msa::fluid::Solver &solver, ofVec2f windowSize, bool drawingFluid, float pRed, float pGreen, float pBlue) {
...
//	glEnable(GL_LINE_SMOOTH);
	...
	for (int i = 0; i < MAX_PARTICLES * 3 * 2; i++)
	{
		if (i % 3 == 0)
			colArray[i] = pRed;
		if (i % 3 == 1)
